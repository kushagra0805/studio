  ...
  return (
    <div className="container mx-auto py-12 px-4 md:px-6">
      <div className="prose prose-blue dark:prose-invert max-w-4xl mx-auto">
        <h1 className="text-4xl font-bold mb-8">Colocation Policy</h1>
        ...
        <h2 className="text-2xl font-bold mt-8 mb-4">1. Data Center Access</h2>
        ...
        <h2 className="text-2xl font-bold mt-8 mb-4">2. Equipment and Installation</h2>
        <ul className="list-disc list-inside space-y-2">
        ...
        <h2 className="text-2xl font-bold mt-8 mb-4">3. Shipping and Receiving</h2>
        <ul className="list-disc list-inside space-y-2">
        ...
        <h2 className="text-2xl font-bold mt-8 mb-4">5. Prohibited Items</h2>
        ...
        <h2 className="text-2xl font-bold mt-8 mb-4">6. Remote Hands Services</h2>
