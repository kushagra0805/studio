      ...
      <div className="container mx-auto py-16 px-4 sm:px-6 lg:px-8">
        ...
        <div id="vps" className="mt-20 scroll-mt-20 grid md:grid-cols-2 gap-12 items-center overflow-hidden">
          ...
          <motion.div
            ...
            viewport={{ once: true, amount: 0.3 }}
          >
            <img src="https://placehold.co/450x315.png" alt="Virtual Private Servers" className="rounded-lg shadow-md" data-ai-hint="glowing server" />
          </motion.div>
        </div>
        ...
        <div id="dedicated" className="mt-24 scroll-mt-20 grid md:grid-cols-2 gap-12 items-center overflow-hidden">
          <motion.div 
            ...
            viewport={{ once: true, amount: 0.3 }}
          >
             <img src="https://placehold.co/450x315.png" alt="Dedicated Servers" className="rounded-lg shadow-md" data-ai-hint="data center" />
          </motion.div>
          <motion.div
        ...
        <div id="cloud-x" className="mt-24 scroll-mt-20 pt-10 grid md:grid-cols-2 gap-12 items-center bg-secondary -mx-4 sm:-mx-6 lg:-mx-8 p-4 sm:p-6 lg:p-12 rounded-lg overflow-hidden">
          ...
          <motion.div
             ...
             viewport={{ once: true, amount: 0.3 }}
          >
            <img src="https://placehold.co/450x315.png" alt="Accounting on the Cloud" className="rounded-lg shadow-md" data-ai-hint="cloud accounting" />
          </motion.div>
        </div>
        ...
        <div id="web-hosting" className="mt-24 scroll-mt-20 grid md:grid-cols-2 gap-12 items-center overflow-hidden">
           <motion.div 
            ...
            viewport={{ once: true, amount: 0.3 }}
           >
             <img src="https://placehold.co/450x315.png" alt="Web Hosting" className="rounded-lg shadow-md" data-ai-hint="modern website" />
          </motion.div>
          <motion.div
            variants={textFromRight}
            initial="hidden"
        ...
        <div id="colocation" className="mt-24 scroll-mt-20 grid md:grid-cols-2 gap-12 items-center overflow-hidden">
          ...
          <motion.div
            ...
            viewport={{ once: true, amount: 0.3 }}
          >
            <img src="https://placehold.co/450x315.png" alt="Server Colocation" className="rounded-lg shadow-md" data-ai-hint="server racks" />
          </motion.div>
        </div>
        ...
        <div id="on-premise-cloud" className="mt-24 scroll-mt-20 grid md:grid-cols-2 gap-12 items-center overflow-hidden">
           <motion.div 
            ...
            viewport={{ once: true, amount: 0.3 }}
           >
             <img src="https://placehold.co/450x315.png" alt="On-premise Cloud" className="rounded-lg shadow-md" data-ai-hint="private secure cloud" />
          </motion.div>
          <motion.div
            variants={textFromRight}
            initial="hidden"
