  ...
  return (
    <div className="container mx-auto py-12 px-4 md:px-6">
      <div className="prose prose-blue dark:prose-invert max-w-4xl mx-auto">
        ...
        <h2 className="text-2xl font-bold mt-8 mb-4">Prohibited Uses of M A Global Network Systems and Services</h2>
        ...
        <h2 className="text-2xl font-bold mt-8 mb-4">Revisions to This AUP</h2>
